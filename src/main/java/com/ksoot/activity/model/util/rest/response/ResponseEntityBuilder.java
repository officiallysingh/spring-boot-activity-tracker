package com.ksoot.activity.model.util.rest.response;

import ai.whilter.common.util.rest.response.builder.AbstractResponseBuilder;
import ai.whilter.common.util.rest.response.builder.BodyBuilder;
import ai.whilter.common.util.rest.response.builder.HeaderBuilder;
import ai.whilter.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
